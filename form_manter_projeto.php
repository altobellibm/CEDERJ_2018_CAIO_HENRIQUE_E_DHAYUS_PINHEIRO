...
if (isset($_GET['id_proj'])){
	...
	$html='<form method="post" action="armazena_projeto.php" id="form_mt_proj" name="form_mt_proj">';
...
MED;
	...
	$html.='<button type="submit" value="Submit">Salvar</button>   &Uacuteltima atualiza&ccedil&atildeo em '.$tbl['versao'].'</form>';
